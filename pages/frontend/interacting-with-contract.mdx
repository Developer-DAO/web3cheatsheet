...
Interacting with a contract does not give you access to loading or error states via a hook, though. You have to handle all of that 'manually' here. Proceed to the next page to learn about how `useContractRead` and `useContractWrite` solve this.
